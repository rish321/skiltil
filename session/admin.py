...
list_filter = ['belong_session', 'belong_session__session_number', 'belong_session__skill_match__skill__topic',
               'belong_session__skill_match__skill', 'belong_session__skill_match__customer', 'belong_session__student']
...
class SessionAdmin(admin.ModelAdmin):
    ...
    list_filter = ['session_number', 'skill_match__skill__topic', 'skill_match__skill', 'skill_match__customer',
                   'student']
    list_display = ['skill_match', 'student', 'session_number', 'amount_to_teacher', 'balance_amount', 'start_time', ]
    search_fields = ['skill_match__skill__topic__topic_name', 'skill_match__skill__skill_name',
                     'skill_match__customer__customer_name', 'student__customer_name', 'session_number']
    readonly_fields = ['session_number', 'total_calls', 'total_duration', 'minutes_duration', 'start_time', 'end_time',
