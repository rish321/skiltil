...
class SkillAdmin(BaseAdmin):
    ...
    list_filter = ["no_teachers", "topic", "exclusive", "visible", 'skill_rating_count', "student_pricing",
                   "teacher_pricing"]
    list_display = ['skill_code', "skill_name", "topic", "clicks", "classes_given", "no_teachers", "exclusive",
                    "visible", 'get_skill_rating', 'skill_rating_count', "student_pricing", "teacher_pricing"]
...
class EventAdmin(SkillTopicAdmin):
    readonly_fields = ['is_event', ]
...
class CustomerRequestAdmin(BaseAdmin):
    ...
    list_display = ['contact_name', "contact_phone", "contact_email", "default_skill", "skill",
                    "preferred_communication_time", ]
    search_fields = ['contact_name', "contact_phone", "contact_email", "default_skill", "skill", ]
    readonly_fields = ['contact_name', "contact_phone", "contact_email", "default_skill", "skill",
                       "preferred_communication_time", "content"]
